...
<dt> Hong Xu, Ye Jiang, Yimin Wang, Yewei Sun, Xueqing Li. (2015). Proceedings of the 2015 JIMET Conference, 2015.</dt>
*  Comparing Attitudes to Climate Change in the Media using sentiment analysis based on Latent Dirichlet Allocation.
<dt> Ye Jiang, Xingyi Song, Jackie Harrison, Shaun Quegan, and Diana Maynard. Proceedings of the 2017 EMNLP Workshop: Natural   Language Processing meets Journalism, 2017.</dt>
